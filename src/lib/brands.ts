...
export const supplierBrands: SupplierBrand[] = [
  ...
  },
  {
    ...
    page: {
      ...
      category: "locksmith",
      answerFirst:
        "Downtown Doors & Security Systems NYC installs, repairs, and rekeys Schlage locks — deadbolts, levers, and smart/keyless models — for residential and commercial doors across the five boroughs. We carry Schlage cylinders and key blanks on the truck for same-visit work.",
      whatWeService: [
  ...
  },
  {
    ...
    page: {
      ...
      category: "security",
      answerFirst:
        "Downtown Doors & Security Systems NYC installs and repairs ENFORCER panic bars and exit devices — the push-bar hardware required on many commercial and assembly exits so occupants can get out instantly in an emergency, no key or knowledge needed.",
      whatWeService: [
  ...
  },
  {
    ...
    page: {
      ...
      category: "security",
      answerFirst:
        "Downtown Doors & Security Systems NYC installs Rosslare card readers and keypads as part of commercial access-control systems — letting property owners and businesses manage who can open a door with a credential instead of a physical key.",
      whatWeService: [
  ...
  },
  {
    ...
    page: {
      ...
      category: "security",
      answerFirst:
        "Downtown Doors & Security Systems NYC installs Seco-Larm door and window sensors, magnetic door holders, and alarm accessories as part of a security or access-control system — the components that tell an alarm panel when a door has been opened.",
      whatWeService: [
