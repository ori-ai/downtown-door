...
const brooklyn: AreaHub = {
  ...
  published: true,
  intro:
    "Downtown Locksmith & Security Intercoms serves all of Brooklyn — from brownstone entry doors in the Heights and Park Slope to storefront and loft doors in Williamsburg, DUMBO, and Bushwick. We handle door repair, installation, locksmith work, and security systems for homes and businesses across the borough.",
  neighborhoods: [
    {
      slug: "brooklyn-heights",
      name: "Brooklyn Heights",
      intro:
        "In Brooklyn Heights, Downtown Locksmith & Security Intercoms repairs and restores the historic entry doors, brownstone vestibules, and apartment doors the neighborhood is known for — along with locksmith and security work for its townhouses and small businesses.",
      localContext:
    ...
    },
    {
      ...
      name: "Williamsburg",
      intro:
        "In Williamsburg, Downtown Locksmith & Security Intercoms handles everything from loft and converted-warehouse doors to the storefront and restaurant entrances along Bedford and Berry — repair, installation, locksmith, and commercial security systems.",
      localContext:
    ...
    },
    {
      ...
      name: "Bushwick",
      intro:
        "In Bushwick, Downtown Locksmith & Security Intercoms serves apartment and multi-family entry doors, warehouse and studio spaces, and the neighborhood's growing storefronts — repair, installation, locksmith, and security work.",
      localContext:
    ...
    },
    {
      ...
      name: "Greenpoint",
      intro:
        "In Greenpoint, Downtown Locksmith & Security Intercoms works on the neighborhood's rowhouse and multi-family entry doors, converted-warehouse spaces, and the storefronts along Manhattan and Franklin — door repair, installation, locksmith, and commercial security.",
      localContext:
    ...
    },
    {
      ...
      intro:
        "In Carroll Gardens, Downtown Locksmith & Security Intercoms handles brownstone and rowhouse entry doors, garden-apartment doors, and the Smith and Court Street storefronts — repair, installation, locksmith, and commercial security.",
      localContext:
    ...
    },
    {
      ...
      name: "Boerum Hill",
      intro:
        "In Boerum Hill, Downtown Locksmith & Security Intercoms services brownstone and rowhouse entry doors, apartment doors, and the Atlantic and Smith Street storefronts — repair, installation, locksmith, and commercial security.",
      localContext:
    ...
    },
    {
      ...
      name: "Crown Heights",
      intro:
        "In Crown Heights, Downtown Locksmith & Security Intercoms serves multi-family and brownstone entry doors, apartment doors, and the Franklin and Nostrand Avenue storefronts — repair, installation, locksmith, and security work.",
      localContext:
...
const manhattan: AreaHub = {
  ...
  published: true,
  intro:
    "Downtown Locksmith & Security Intercoms serves Manhattan — with a focus on Lower Manhattan and the surrounding neighborhoods. We repair and install residential and commercial doors and provide locksmith and security-system services for apartments, offices, and storefronts across the borough.",
  neighborhoods: [
    {
      slug: "tribeca",
      name: "Tribeca",
    ...
    },
    {
      ...
      intro:
        "In the Financial District, Downtown Locksmith & Security Intercoms handles office and commercial building doors, residential conversions, and street-level retail — repair, installation, locksmith, and access-control systems.",
      localContext:
    ...
    },
    {
      ...
      name: "Chelsea",
      intro:
        "In Chelsea, Downtown Locksmith & Security Intercoms works on residential building doors, gallery and office entrances, and retail storefronts — repair, installation, locksmith, and commercial security systems.",
      localContext:
    ...
    },
    {
      ...
      name: "West Village",
      intro:
        "In the West Village, Downtown Locksmith & Security Intercoms handles townhouse and brownstone entry doors, apartment doors, and the neighborhood's small storefronts and restaurants — repair, installation, locksmith, and security work.",
      localContext:
    ...
    },
    {
      ...
      name: "East Village",
      intro:
        "In the East Village, Downtown Locksmith & Security Intercoms services tenement and walk-up entry doors, apartment doors, and the neighborhood's bars, restaurants, and storefronts — repair, installation, locksmith, and security.",
      localContext:
    ...
    },
    {
      ...
      name: "Midtown",
      intro:
        "In Midtown, Downtown Locksmith & Security Intercoms handles commercial and office building doors, residential tower entrances, and street-level retail — door repair, installation, locksmith, and access-control systems for one of the city's busiest commercial districts.",
      localContext:
...
const queens: AreaHub = {
  ...
  published: true,
  intro:
    "Downtown Locksmith & Security Intercoms serves Queens — from the pre-war apartment buildings and rowhouses of Astoria and Jackson Heights to the high-rise towers of Long Island City and the dense retail corridors of Flushing and Elmhurst. We handle door repair, installation, locksmith work, and security systems across the borough's homes, apartment buildings, and businesses.",
  neighborhoods: [
    {
      slug: "astoria",
      name: "Astoria",
      intro:
        "In Astoria, Downtown Locksmith & Security Intercoms services the neighborhood's pre-war multi-family apartment buildings, rowhouses, and the restaurant and retail strips along Broadway and 30th Avenue — door repair, installation, locksmith, and security work.",
      localContext:
    ...
    },
    {
      ...
      name: "Flushing",
      intro:
        "In Flushing, Downtown Locksmith & Security Intercoms handles apartment and co-op building doors, storefront entrances along Main Street and Roosevelt Avenue, and office doors — repair, installation, locksmith, and commercial security.",
      localContext:
    ...
    },
    {
      ...
      name: "Forest Hills",
      intro:
        "In Forest Hills, Downtown Locksmith & Security Intercoms works on the Tudor-style homes of Forest Hills Gardens, large pre-war apartment buildings along Queens Boulevard, and the Austin Street storefronts — repair, installation, locksmith, and security.",
      localContext:
    ...
    },
    {
      ...
      name: "Elmhurst",
      intro:
        "In Elmhurst, Downtown Locksmith & Security Intercoms handles dense multi-family apartment buildings, the storefronts along Broadway and Grand Avenue, and neighborhood offices — door repair, installation, locksmith, and commercial security.",
      localContext:
    ...
    },
    {
      ...
      name: "Woodside",
      intro:
        "In Woodside, Downtown Locksmith & Security Intercoms services two-family homes, multi-family walk-up buildings, and the retail strip along Roosevelt Avenue — door repair, installation, locksmith, and security work.",
      localContext:
...
const theBronx: AreaHub = {
  ...
  published: true,
  intro:
    "Downtown Locksmith & Security Intercoms serves the Bronx — from the co-ops and single-family homes of Riverdale and Throggs Neck to the dense apartment buildings along the Grand Concourse and the busy retail corridor of Fordham Road. We provide door repair, installation, locksmith work, and security systems for homes and businesses across the borough.",
  neighborhoods: [
    {
      slug: "riverdale",
      name: "Riverdale",
      intro:
        "In Riverdale, Downtown Locksmith & Security Intercoms services single-family homes, co-op and condo towers, and the retail strip along Riverdale Avenue — door repair, installation, locksmith, and security work.",
      localContext:
    ...
    },
    {
      ...
      name: "Mott Haven",
      intro:
        "In Mott Haven, Downtown Locksmith & Security Intercoms handles converted industrial loft buildings, rowhouses, and newer waterfront residential development — door repair, installation, locksmith, and access-control systems.",
      localContext:
    ...
    },
    {
      ...
      name: "Concourse",
      intro:
        "In Concourse, Downtown Locksmith & Security Intercoms works on the historic apartment buildings along the Grand Concourse and neighboring multi-family walk-ups — door repair, installation, locksmith, and security systems.",
      localContext:
    ...
    },
    {
      ...
      name: "Kingsbridge",
      intro:
        "In Kingsbridge, Downtown Locksmith & Security Intercoms services multi-family apartment buildings and the commercial strip along Kingsbridge Road and Broadway — door repair, installation, locksmith, and security.",
      localContext:
    ...
    },
    {
      ...
      name: "Parkchester",
      intro:
        "In Parkchester, Downtown Locksmith & Security Intercoms services the neighborhood's large cooperative apartment complex and surrounding multi-family buildings and retail — door repair, installation, locksmith, and access-control systems.",
      localContext:
...
const statenIsland: AreaHub = {
  ...
  published: true,
  intro:
    "Downtown Locksmith & Security Intercoms serves Staten Island — from the rowhouses and multi-family buildings near St. George and Stapleton to the single-family homes that make up much of the island's South Shore, including Great Kills and Tottenville. We provide door repair, installation, locksmith work, and security systems for homes and businesses across the borough.",
  neighborhoods: [
    {
      slug: "st-george",
      name: "St. George",
      intro:
        "In St. George, Downtown Locksmith & Security Intercoms services the neighborhood's rowhouses, multi-family buildings, and the commercial corridor near the ferry terminal — door repair, installation, locksmith, and security work.",
      localContext:
    ...
    },
    {
      ...
      name: "West Brighton",
      intro:
        "In West Brighton, Downtown Locksmith & Security Intercoms services single- and two-family homes and the local retail strip along Forest Avenue — door repair, installation, locksmith, and security work.",
      localContext:
    ...
    },
    {
      ...
      name: "New Dorp",
      intro:
        "In New Dorp, Downtown Locksmith & Security Intercoms services single-family homes and the retail strip along New Dorp Lane — door repair, installation, locksmith, and security work.",
      localContext:
    ...
    },
    {
      ...
      name: "Tottenville",
      intro:
        "In Tottenville, Downtown Locksmith & Security Intercoms services the single-family homes of Staten Island's southernmost neighborhood and its small Main Street commercial strip — door repair, installation, locksmith, and security work.",
      localContext:
    ...
    },
    {
      ...
      name: "Eltingville",
      intro:
        "In Eltingville, Downtown Locksmith & Security Intercoms services single-family and townhouse developments and the retail strip near the Eltingville Transit Center — door repair, installation, locksmith, and security work.",
      localContext:
...
const nassauCounty: AreaHub = {
  ...
  published: false,
  intro:
    "Downtown Locksmith & Security Intercoms serves Nassau County for locksmith, security-system, and door work -- available by request alongside our core five-borough coverage.",
  neighborhoods: [
    {
      slug: "hempstead",
      name: "Hempstead",
    ...
    },
    {
      ...
      name: "Freeport",
      intro:
        "In Freeport, Downtown Locksmith & Security Intercoms handles locksmith, security, and door work for homes and the businesses along the Nautical Mile and Main Street.",
      localContext:
...
const westchesterCounty: AreaHub = {
  ...
  published: false,
  intro:
    "Downtown Locksmith & Security Intercoms serves Westchester County for locksmith, security-system, and door work -- available by request alongside our core five-borough coverage.",
  neighborhoods: [
    {
      slug: "yonkers",
      name: "Yonkers",
    ...
    },
    {
      ...
      name: "New Rochelle",
      intro:
        "In New Rochelle, Downtown Locksmith & Security Intercoms handles locksmith, security, and door work for homes and the businesses downtown.",
      localContext:
...
const rocklandCounty: AreaHub = {
  ...
  published: false,
  intro:
    "Downtown Locksmith & Security Intercoms serves Rockland County for locksmith, security-system, and door work -- available by request alongside our core five-borough coverage.",
  neighborhoods: [
    {
      slug: "nyack",
      name: "Nyack",
    ...
    },
    {
      ...
      name: "Spring Valley",
      intro:
        "In Spring Valley, Downtown Locksmith & Security Intercoms services homes, apartment buildings, and businesses -- locksmith, rekeying, and security systems.",
      localContext:
...
const bergenCounty: AreaHub = {
  ...
  published: false,
  intro:
    "Downtown Locksmith & Security Intercoms serves Bergen County, NJ for locksmith, security-system, and door work -- available by request alongside our core five-borough coverage.",
  neighborhoods: [
    {
      slug: "hackensack",
      name: "Hackensack",
    ...
    },
    {
      ...
      name: "Englewood",
      intro:
        "In Englewood, Downtown Locksmith & Security Intercoms services homes and the businesses downtown -- locksmith work, security systems, and door repair.",
      localContext:
