...
const allServices: Service[] = [
  {
    ...
    answerFirst:
      "Downtown Doors, Locksmith & Security Systems NYC repairs residential and commercial doors across the five boroughs — fixing misaligned or sticking doors, damaged frames and jambs, failing hinges and closers, and worn hardware. Most repairs are diagnosed on-site and completed the same visit whenever parts are on hand.",
  ...
  },
  {
    ...
    answerFirst:
      "Downtown Doors, Locksmith & Security Systems NYC provides emergency door repair across the five boroughs when a door won't lock, won't close, or has been damaged in a break-in. We respond quickly to secure the opening first, then complete a proper repair — so your home or business isn't left exposed.",
  ...
  },
  {
    ...
    answerFirst:
      "Downtown Doors, Locksmith & Security Systems NYC repairs and installs commercial and storefront doors throughout the five boroughs — aluminum storefront systems, glass entrances, high-traffic office doors, closers, pivots, and panic hardware. We keep business entrances opening smoothly, closing securely, and meeting code.",
