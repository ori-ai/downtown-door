...
const allServices: Service[] = [
  {
    ...
    answerFirst:
      "Downtown Door Repair & Security repairs residential and commercial doors across the five boroughs — fixing misaligned or sticking doors, damaged frames and jambs, failing hinges and closers, and worn hardware. Most repairs are diagnosed on-site and completed the same visit whenever parts are on hand.",
  ...
  },
  {
    ...
    answerFirst:
      "Downtown Door Repair & Security provides emergency door repair across the five boroughs when a door won't lock, won't close, or has been damaged in a break-in. We respond quickly to secure the opening first, then complete a proper repair — so your home or business isn't left exposed.",
  ...
  },
  {
    ...
    answerFirst:
      "Downtown Door Repair & Security repairs and installs commercial and storefront doors throughout the five boroughs — aluminum storefront systems, glass entrances, high-traffic office doors, closers, pivots, and panic hardware. We keep business entrances opening smoothly, closing securely, and meeting code.",
  ...
  },
  {
    ...
    answerFirst:
      "Downtown Door Repair & Security handles locksmith and door hardware work across the five boroughs — lock repair and rekeying, deadbolt and smart-lock installation, master key systems, and hardware like closers, hinges, and panic bars. We make sure your doors lock securely and the right people have access.",
  ...
  },
  {
    ...
    answerFirst:
      "Downtown Door Repair & Security repairs and installs security gates and roll-down gates across the five boroughs — rolling steel and open-grille storefront gates, scissor gates, their motors, springs, and locks. We keep the gate that protects your storefront rolling smoothly and locking securely.",
  ...
  },
  {
    ...
    answerFirst:
      "Downtown Door Repair & Security installs and repairs intercom and buzzer entry systems across the five boroughs — audio and video intercoms for apartment buildings, offices, and multi-unit properties, integrated with electric strikes and maglocks so tenants and visitors can be seen, spoken to, and let in.",
