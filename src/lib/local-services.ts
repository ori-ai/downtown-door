...
export const localServices: LocalService[] = [
  {
    ...
    parent: "door-repair",
    intro:
      "Downtown Doors & Security provides door repair in {n}, {b} — fixing sticking and sagging doors, damaged frames and jambs, worn hinges, and failing closers for homes and businesses. Most repairs are diagnosed on site and finished the same visit when parts are on hand.",
    points: [
  ...
  },
  {
    ...
    intro:
      "Downtown Doors & Security installs and replaces doors in {n}, {b} — entry and interior doors for homes, and commercial, office, and fire-rated doors for businesses. Every door is measured, fitted, and hung so it seals, swings, and locks correctly from day one.",
    points: [
  ...
  },
  {
    ...
    intro:
      "Downtown Doors & Security provides emergency door repair in {n}, {b} — when a door won't lock, won't close, or has been damaged in a break-in. We move fast to secure the opening first, then complete a proper repair so your {n} home or business isn't left exposed.",
    points: [
  ...
  },
  {
    ...
    intro:
      "Downtown Doors & Security repairs commercial doors in {n}, {b} — high-traffic office, retail, and building entrances, hollow-metal and aluminum doors, and the closers, pivots, and panic hardware that go with them. We keep {n} business entrances opening smoothly, closing securely, and meeting code.",
    points: [
  ...
  },
  {
    ...
    parent: "door-installation",
    intro:
      "Downtown Doors & Security installs commercial doors in {n}, {b} — office, retail, hollow-metal, and fire-rated door assemblies fitted to code, with the closers, panic hardware, and locks a business entrance needs. Doors are measured and hung so they seal and secure from day one.",
    points: [
  ...
  },
  {
    ...
    parent: "commercial-storefront-doors",
    intro:
      "Downtown Doors & Security repairs storefront doors in {n}, {b} — aluminum storefront systems, glass entrances, pivots, closers, and thresholds for retail, restaurants, and offices. We keep your {n} storefront opening smoothly and locking securely at the end of the day.",
    points: [
  ...
  },
  {
    ...
    parent: "commercial-storefront-doors",
    intro:
      "Downtown Doors & Security installs storefront doors in {n}, {b} — aluminum storefront entrances, glass doors, and the closers, pivots, and panic hardware retail and restaurant entrances need. Each {n} storefront is fitted to seal, swing, and lock correctly from day one.",
    points: [
  ...
  },
  {
    ...
    parent: "commercial-storefront-doors",
    intro:
      "Downtown Doors & Security installs and repairs door closers in {n}, {b} — surface and concealed closers for apartment, office, storefront, and fire-rated doors. We set the closing speed and latch so the door shuts fully and securely every time, and meets code where required.",
    points: [
  ...
  },
  {
    ...
    intro:
      "Downtown Doors & Security repairs intercom and buzzer entry systems in {n}, {b} — audio and video intercoms for apartment buildings, offices, and multi-unit properties. We get tenant entry, door-release, and buzzers working again so residents and visitors can get in.",
    points: [
  ...
  },
  {
    ...
    parent: "security-systems-access-control",
    intro:
      "Downtown Doors & Security installs intercom and buzzer entry systems in {n}, {b} — audio and video intercoms for apartment buildings, offices, and multi-unit properties, integrated with electric strikes or maglocks for secure tenant and visitor entry.",
    points: [
  ...
  },
  {
    ...
    intro:
      "Downtown Doors & Security provides locksmith service in {n}, {b} — lock repair and rekeying, deadbolt and smart-lock installation, and door hardware for homes and businesses. We make sure your {n} doors lock securely and the right people have access.",
    points: [
  ...
  },
  {
    ...
    parent: "locksmith-door-hardware",
    intro:
      "Downtown Doors & Security is a commercial locksmith in {n}, {b} — master key systems, high-security and commercial-grade locks, panic hardware, and access control for offices, retail, and multi-unit buildings. We control who gets into your {n} property and keep it secure.",
    points: [
  ...
  },
  {
    ...
    parent: "locksmith-door-hardware",
    intro:
      "Downtown Doors & Security changes and rekeys locks in {n}, {b} — after a move, a tenant change, a lost key, or a break-in. We rekey or replace your {n} locks quickly so old keys no longer work and your door is secure.",
    points: [
  ...
  },
  {
    ...
    parent: "security-systems-access-control",
    intro:
      "Downtown Doors & Security installs access control and keyless entry systems in {n}, {b} — key fob, keypad, and cloud-based credential systems that replace physical keys with managed entry. We wire it into your {n} doors' electric strikes or maglocks so you control exactly who gets in, and when.",
    points: [
  ...
  },
  {
    ...
    intro:
      "Downtown Doors & Security installs security camera and CCTV systems in {n}, {b} — HD and IP cameras with recording and remote viewing for homes, businesses, and multi-unit buildings. We place cameras to cover entrances and blind spots around your {n} property and can tie them into your intercom or access control.",
    points: [
  ...
  },
  {
    ...
    intro:
      "Downtown Doors & Security repairs roll-down and security gates in {n}, {b} — rolling steel and open-grille storefront gates, scissor gates, and their motors, springs, tracks, and locks. We get a stuck or failing {n} storefront gate rolling smoothly and locking securely again.",
    points: [
