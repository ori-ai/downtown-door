    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Plenty of buildings correctly end up with both — a maglock on the glass front door and strikes everywhere else. If you're weighing this for a specific door, the useful next step is a hardware survey of the actual opening, not a phone-call guess. Downtown Door Repair & Security installs and services both, licensed by NYC DCWP (#2109597), with walk-in offices at 170 Hicks Street in Brooklyn Heights and 232 Leonard Street in Williamsburg, and we work across the five boroughs around the clock."
        ]
      }
    ]
  },
