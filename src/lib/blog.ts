    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "Plenty of buildings correctly end up with both — a maglock on the glass front door and strikes everywhere else. If you're weighing this for a specific door, the useful next step is a hardware survey of the actual opening, not a phone-call guess. Downtown Door Repair & Security installs and services both, licensed by NYC DCWP (#2109597), with offices at 170 Hicks Street in Brooklyn Heights and 232 Leonard Street in Williamsburg, and we work across the five boroughs around the clock."
        ]
      }
    ]
  },
    ...
    "sections": [
      ...
      },
      {
        ...
        "paragraphs": [
          ...
          "For owners and managers, the practical takeaway is to treat buzzer complaints with the same urgency as heat and hot water paperwork: log the complaint, get the repair scheduled fast, and keep the invoice as proof of correction. A dead intercom also quietly feeds other problems — tenants prop the front door open, which defeats the self-locking door requirement and invites package theft and worse. Downtown Door Repair & Security (NYC DCWP license #2109597) handles intercom diagnosis and repair across the five boroughs, 24/7, with offices at 170 Hicks Street in Brooklyn Heights and 232 Leonard Street in Williamsburg — and for recurring offenders, we'll tell you straight whether you're maintaining a system or subsidizing a dead one."
        ]
      }
    ]
  }
