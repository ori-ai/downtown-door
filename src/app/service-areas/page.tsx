...
export const metadata: Metadata = {
  ...
  description:
    "Downtown Doors, Locksmith & Security Systems NYC serves all five NYC boroughs with neighborhood-level locksmith, security-system, and door repair service, plus Westchester, Rockland, and Nassau counties, and Bergen County, NJ, by request.",
