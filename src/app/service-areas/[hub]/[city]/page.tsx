      ...
      <section className="relative overflow-hidden border-b border-line">
        ...
        <Container className="grid items-center gap-10 py-12 md:py-16 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div
            ...
            role="img"
            aria-label={`Door, lock, and security work by Downtown Locksmith & Security Intercoms in ${neighborhood.name}, ${hub.name}`}
          >
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_18rem]">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-lg leading-relaxed text-body">
                ...
                camera system, Downtown Locksmith &amp; Security Intercoms handles it across {neighborhood.name}{" "}
