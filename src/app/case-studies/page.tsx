...
export const metadata: Metadata = {
  ...
  description:
    "Real commercial clients Downtown Doors, Locksmith & Security Systems NYC has worked with across the five boroughs — storefront doors, security cameras, lock rekeys, gate repair, and intercom systems.",
