...
export const metadata: Metadata = {
  ...
  description:
    "Mul-T-Lock, Schlage, ENFORCER, Rosslare, Seco-Larm, and other real hardware brands Downtown Locksmith & Security Intercoms installs and services across the five boroughs.",
