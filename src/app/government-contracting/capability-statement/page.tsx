...
export const metadata: Metadata = {
  ...
  description:
    "Request the Downtown Doors & Security Systems NYC capability statement — company overview, services, licensing, insurance, and how to engage us on institutional projects.",
