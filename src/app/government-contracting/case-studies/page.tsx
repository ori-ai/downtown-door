...
export const metadata: Metadata = {
  ...
  description:
    "Past institutional door and security project references from Downtown Door Repair & Security, provided to procurement teams on request.",
        ...
        <Container>
          {caseStudies.length === 0 ? (
            ...
            <div className="grid gap-5 md:grid-cols-2">
              {caseStudies.map((cs) => (
                <div key={cs.project} className="rounded-2xl border border-line bg-white p-7">
