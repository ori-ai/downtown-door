...
export const metadata: Metadata = {
  title: "Reviews",
  description:
    "Read what customers say about Downtown Locksmith & Security Intercoms. Reviews are pulled live from our Google Business Profile.",
          ...
          <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {reviewStrip.map((src) => (
              <div key={src} className="relative aspect-square overflow-hidden rounded-xl border border-line ring-soft">
                <Image src={src} alt="Real job, Downtown Locksmith & Security Intercoms" fill sizes="(max-width: 640px) 50vw, 20vw" className="object-cover" />
              </div>
            ))}
          </div>
        </Container>
